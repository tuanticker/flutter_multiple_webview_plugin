[![Flutter Community: flutter_multiple_webview_plugin]

# NOTICE
> This webview package allow you to you multiple webviews instances.
> 
> Keep Fluttering!
...
`FlutterMultipleWebviewPlugin` provide a singleton instance linked to one unique webview,
