...
class WebviewManager {
    ...
    public final static String WEBVIEW_ID_INTENT = "webViewId";
    private Uri fileUri;
    ...
    WebviewManager(final Activity activity, final Context context, final List<String> channelNames, final String id) {
                    ...
                    switch (keyCode) {
                        case KeyEvent.KEYCODE_BACK:
                            if (webView.canGoBack()) {
                                ...
                                FlutterMultipleWebviewPlugin.channel.invokeMethod("onBack", null);
                            }
                            return true;
                    }
                }
        ...
        ((ObservableWebView) webView).setOnScrollChangedCallback(new ObservableWebView.OnScrollChangedCallback() {
            public void onScroll(int x, int y, int oldx, int oldy) {
                ...
                yDirection.put("id", webView.getTag());
                FlutterMultipleWebviewPlugin.channel.invokeMethod("onScrollYChanged", yDirection);
                Map<String, Object> xDirection = new HashMap<>();
                xDirection.put("xDirection", (double) x);
                xDirection.put("id", webView.getTag());
                FlutterMultipleWebviewPlugin.channel.invokeMethod("onScrollXChanged", xDirection);
            }
        });
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg) {
                ...
                i.setType("image/*");
                i.putExtra(WEBVIEW_ID_INTENT, webViewId);
            ...
            public boolean onShowFileChooser(
                ...
                chooserIntent.putExtra(WEBVIEW_ID_INTENT, webViewId);
            ...
            public void onProgressChanged(WebView view, int progress) {
                ...
                args.put("id", view.getTag());
                FlutterMultipleWebviewPlugin.channel.invokeMethod("onProgressChanged", args);
            }
            ...
            public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
                ...
                obj.put("id", webView.getTag());
                FlutterMultipleWebviewPlugin.channel.invokeMethod("onConsoleMessage", obj);
                return true;
            }
    ...
    private void registerJavaScriptChannelNames(List<String> channelNames) {
        for (String channelName : channelNames) {
            webView.addJavascriptInterface(
                    new JavaScriptChannel(FlutterMultipleWebviewPlugin.channel, channelName, platformThreadHandler), channelName);
        }
    }
    ...
    void openUrl(
            ...
            boolean overScrollNever,
            boolean transparentBackground,
            boolean disableSystemFontSize
    ) {
    ...
    void close(MethodCall call, MethodChannel.Result result) {
        ...
        closed = true;
        FlutterMultipleWebviewPlugin.channel.invokeMethod("onDestroy", null);
    }
